...
if(isset($postdata) && !empty($postdata))
{
	...
	if(mysqli_query($con,$sql))
	{
		...
		if (mysqli_query($con,$sql) && $request->packages_assoc) {
		...
		if (mysqli_query($con,$sql) && $request->vendor_assoc) {
		...
		if (mysqli_query($con,$sql) && $request->payment_assoc) {
		...
		if (mysqli_query($con,$sql) && $request->event_details) {
		...
		if (mysqli_query($con,$sql) && $request->extra_details) {
		...
		if (mysqli_query($con,$sql) && $request->attribute_assoc) {
