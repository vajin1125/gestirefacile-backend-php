...
if (!empty($_POST)) 
{
	...
	$sql = "INSERT INTO `users` (`oid`, `superuser`, `name`, `surname`, `username`, `password`, `email`, `enabled`, `tel`, `cell`, `max_business_num`, `change_password`,`image`) VALUES ('{$oid}','{$superuser}', '{$name}','{$surname}', '{$username}','{$pwd}','{$email}', '{$enabled}','{$tel}', '{$cell}', '{$maxbusinessnum}', '{$changepassword}', '{$image}')";
